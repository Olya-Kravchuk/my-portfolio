    ...
    <div className='py-20' id="projects">
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
            {projects.map(({id, title, des, img, iconLists, link}) => (
                ...
                <div key={id} className='flex items-start justify-center sm:w-[calc(45%-2rem)] w-full'>

                    {/* <PinContainer title={title} href={link} > */}
                    <a className='relative flex flex-col w-full overflow-hidden rounded-3xl bg-[#13162d] p-4 transition-transform hover:scale-[1.02] min-h-[28rem]'>
